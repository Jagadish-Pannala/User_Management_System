...
class RoleService:
    ...
    def add_permission_groups_to_role(self, role_uuid: str, group_uuids: list[str], assigned_by: int,audit_data=None, **kwargs):
        new_groups = []
        ...
        try:
            ...
            self.db.rollback()
            raise HTTPException(status_code=500, detail=f"Failed to add permission groups: {str(e)}")
    ...
    def remove_permission_group_from_role(self, role_uuid: str, group_uuid: str,audit_data=None, **kwargs):
