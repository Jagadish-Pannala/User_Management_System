...
-- User Role Mapping (was CASCADE, now RESTRICT)
...
-- Mapping Between Permissions and Groups (was CASCADE, now RESTRICT)
...
-- Endpoint to Permission mapping (was mix of CASCADE/RESTRICT, now all RESTRICT)
...
-- Mapping Between Roles and Permission Groups (was CASCADE on role_id, now RESTRICT)
